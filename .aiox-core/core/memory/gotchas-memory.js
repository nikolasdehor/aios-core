 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .aiox-core/core/memory/
 * - AC2: Persists in .aiox/gotchas.json and .aiox/gotchas.md
...
*Generated by AIOX Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - AIOX Memory Layer (Story 9.4)
